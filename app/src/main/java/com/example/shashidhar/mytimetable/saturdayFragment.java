...
public class saturdayFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.sat_fragment, container, false);
        recyclerView = v.findViewById(R.id.sat_recycler);
        ...
        try {
            ...
            JSONObject jsonObject1= jsonObject.getJSONObject("week").getJSONObject("saturday");
            if(jsonObject1 != null){
