...
public class thursdayFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.thu_fragment, container, false);
        recyclerView = v.findViewById(R.id.thu_recycler);
        ...
        try {
            ...
            JSONObject jsonObject1= jsonObject.getJSONObject("week").getJSONObject("thursday");
            if(jsonObject1 != null){
