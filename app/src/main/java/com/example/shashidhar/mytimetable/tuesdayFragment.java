...
public class tuesdayFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.tue_fragment, container, false);
        recyclerView = v.findViewById(R.id.tue_recycler);
        ...
        try {
            ...
            JSONObject jsonObject1= jsonObject.getJSONObject("week").getJSONObject("tuesday");
            if(jsonObject1 != null){
